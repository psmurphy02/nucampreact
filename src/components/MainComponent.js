...
const mapDispatchToProps = {
  ...
  postFeedback: (firstName,
    ...
    agree,
    contactType,
    feedback) => (postFeedback(firstName,
      lastName,
      phoneNum,
      email,
      agree,
...
class Main extends Component {
  ...
  render() {
    ...
    const CampsiteWithId = ({ match }) => {
      return (
        <CampsiteInfo
          campsite={this.props.campsites.campsites.filter((campsite) => campsite.id === +match.params.campsiteId
            )[0]}
          isLoading={this.props.campsites.isLoading}
          errMess={this.props.campsites.errMess}
          comment={this.props.comments.comments.filter((comment) => comment.campsiteId === +match.params.campsiteId)}
